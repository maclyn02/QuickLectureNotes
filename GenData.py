...
def main():
    imgTrainingNumbers = cv2.imread(sys.argv[1]);          
    ...
    print ("\n\ntraining complete !!\n")
    np.savetxt("D:\Project\\segmented_images\\classifications.txt", npaClassifications)  
    np.savetxt("D:\Project\\segmented_images\\flattened_images.txt", npaFlattenedImages)  
